...
int main( int argc, char *argv[] )
{
    ...
    if(myid==0) {
        //MPI_Send(array, ARRAY_SIZE,MPI_INT,1,1,MPI_COMM_WORLD);
	...
	MPI_Recv(&buffer[0], BUF_SIZE, MPI_DOUBLE, 0, 1, MPI_COMM_WORLD, &Stat);
        ...
        //cout << endl <<"id: " << myid << endl << "receiveB" << endl << matrix2 << endl;
