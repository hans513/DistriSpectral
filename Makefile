...
main: main.cpp Master.cpp Slave.cpp DataGenerator.cpp Task.cpp Logic.cpp Fastfood.cpp
	mpicxx -I $(EIGEN) -I $(EIGEN)/unsupported -std=c++11 -O3 -o eigenMpi main.cpp Master.cpp Slave.cpp DataGenerator.cpp Task.cpp Logic.cpp Fastfood.cpp

ch: main.cpp Master.cpp Slave.cpp DataGenerator.cpp Task.cpp Logic.cpp Fastfood.cpp
	$(CHCXX) -I $(EIGEN) -I $(EIGEN)/unsupported -std=c++11 -O3 -o eigenMpich main.cpp Master.cpp Slave.cpp DataGenerator.cpp Task.cpp Logic.cpp Fastfood.cpp
